...
constexpr ECommands MPCalc<T>::getCommandCode(std::string const &string) {
...
template<size_t T>
requires AtLeastFourBytes<T>
constexpr int MPCalc<T>::getBankIndex(std::string const &string) {
...
template<size_t T>
requires AtLeastFourBytes<T>
bool MPCalc<T>::handleUserInput(std::stringstream &arguments) {
    try {
...
template<size_t T>
requires AtLeastFourBytes<T>
bool MPCalc<T>::applyCommand(std::stringstream &arguments) {
    std::string command;
...
template<size_t T>
requires AtLeastFourBytes<T>
void MPCalc<T>::addToBank(const MPInt<T> &num) {
...
template<size_t T>
requires AtLeastFourBytes<T>
void MPCalc<T>::loadScript(const std::filesystem::path &path) {
